const CACHE='qualita-aria-v0.5.15';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./css/aria-splash.css?v=0.5.14','./css/header-overrides.css?v=0.5.14','./css/trees.css?v=0.5.14','./js/aria-splash.js?v=0.5.14','./js/app.js?v=0.5.15','./js/trees.js?v=0.5.14','./data/trees.json?v=0.5.14','./data/tree-coordinates.json?v=0.5.14','./data/tree-paths.json?v=0.5.14','./data/trees-proxy.json?v=0.5.14','./assets/branding/aria-logo-header.svg','./js/eea-utd.js?v=0.2.14',
  ...
  './manifest.json?v=0.2.0','./version.json?v=0.5.15','./data/version.json?v=0.5.15','./data/italian-capitals.json?v=0.5.15',
