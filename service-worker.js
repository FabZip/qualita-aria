const CACHE='qualita-aria-v0.5.13';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./css/aria-splash.css?v=0.5.13','./css/header-overrides.css?v=0.5.13','./css/trees.css?v=0.5.13','./js/aria-splash.js?v=0.5.13','./js/app.js?v=0.5.13','./js/trees.js?v=0.5.13','./data/trees.json?v=0.5.13','./data/tree-coordinates.json?v=0.5.13','./data/tree-paths.json?v=0.5.13','./data/trees-proxy.json?v=0.5.13','./assets/branding/aria-logo-header.svg','./js/eea-utd.js?v=0.2.14',
  ...
  './manifest.json?v=0.2.0','./version.json?v=0.5.13','./data/version.json?v=0.5.13','./data/italian-capitals.json?v=0.5.13',
