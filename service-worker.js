const CACHE='qualita-aria-v0.4.2';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./css/trees.css?v=0.4.2','./js/app.js?v=0.4.2','./js/trees.js?v=0.4.2','./data/trees.json?v=0.4.2','./js/eea-utd.js?v=0.2.14',
  ...
  './manifest.json?v=0.2.0','./version.json?v=0.4.2','./data/version.json?v=0.4.2','./data/italian-capitals.json?v=0.4.2',
