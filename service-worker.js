const CACHE='qualita-aria-v0.3.7';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./js/app.js?v=0.3.7','./js/eea-utd.js?v=0.2.14',
  './css/station-list.css?v=0.2.2','./css/openaq-world.css?v=0.2.4','./js/station-list.js?v=0.2.11',
  './js/openaq-proxy.js?v=0.2.11','./js/eea-proxy.js?v=0.2.14','./data/eea-proxy.json?v=0.2.14','./js/temperature-proxy.js?v=0.3.7','./js/temperature-overlay.js?v=0.3.7','./data/temperature-proxy.json?v=0.3.7','./css/temperature.css?v=0.3.7','./js/openaq-world.js?v=0.3.7',
  './manifest.json?v=0.2.0','./version.json?v=0.3.6','./data/version.json?v=0.3.6','./data/italian-capitals.json?v=0.3.6',
