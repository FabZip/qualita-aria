const CACHE='qualita-aria-v0.4.9';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./css/aria-splash.css?v=0.4.9','./css/trees.css?v=0.4.9','./js/aria-splash.js?v=0.4.9','./js/app.js?v=0.4.9','./js/trees.js?v=0.4.9','./data/trees.json?v=0.4.9','./data/tree-coordinates.json?v=0.4.9','./data/trees-proxy.json?v=0.4.9','./js/eea-utd.js?v=0.2.14',
  ...
  './manifest.json?v=0.2.0','./version.json?v=0.4.9','./data/version.json?v=0.4.9','./data/italian-capitals.json?v=0.4.9',
