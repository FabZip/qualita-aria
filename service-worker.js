const CACHE='qualita-aria-v0.3.9';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./js/app.js?v=0.3.9','./js/eea-utd.js?v=0.2.14',
  ...
  './manifest.json?v=0.2.0','./version.json?v=0.3.9','./data/version.json?v=0.3.9','./data/italian-capitals.json?v=0.3.9',
