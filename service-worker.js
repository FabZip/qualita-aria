const CACHE='qualita-aria-v0.5.0';
const CORE=[
  './','./index.html',
  './css/app.css?v=0.2.0','./css/aria-splash.css?v=0.5.0','./css/trees.css?v=0.5.0','./js/aria-splash.js?v=0.5.0','./js/app.js?v=0.5.0','./js/trees.js?v=0.5.0','./data/trees.json?v=0.5.0','./data/tree-coordinates.json?v=0.5.0','./data/tree-paths.json?v=0.5.0','./data/trees-proxy.json?v=0.5.0','./js/eea-utd.js?v=0.2.14',
  ...
  './manifest.json?v=0.2.0','./version.json?v=0.5.0','./data/version.json?v=0.5.0','./data/italian-capitals.json?v=0.5.0',
