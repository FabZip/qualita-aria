...
La scansione degli eventi arborei di Roma distingue la pubblicazione dell’avviso dalla data operativa dell’intervento. Un avviso pubblicato nei mesi precedenti può quindi inserire correttamente un intervento programmato fino al 31 dicembre dello stesso anno. Le attività future restano escluse dai totali degli eventi eseguiti. App 0.7.5 build 85, dataset invariato alla revisione 22, Worker 0.9.9.
